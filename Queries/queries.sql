...
-- w/ departments = d and dept_manager = dm
SELECT d.dept_name,
    dm.emp_no,
	dm.from_date,
	dm.to_date
...
-- Joining retirement_info and dept_emp tables, creates
-- table containing only the current employees eligible for retirement.
SELECT ri.emp_no,
    ri.first_name,
	ri.last_name,
de.to_date
...
-- Department Retirees in Sales (7.3.6, #1)
SELECT ce.emp_no,
       ce.first_name,
	   ce.last_name,
	   d.dept_name
...
-- Department Retirees in Sales or Development (7.3.6, #2)
SELECT ce.emp_no,
       ce.first_name,
	   ce.last_name,
	   d.dept_name
